...
# Submission script. Run cufflinks in monocytes' BAM files
...
mkdir ../cufflinks/monocytes/${OUTPUT[ $SGE_TASK_ID ]}

cufflinks -q -G $ANNO -u --library-type fr-firststrand --max-bundle-length 1000000000 -p 4 -o ../cufflinks/monocytes/${OUTPUT[ $SGE_TASK_ID ]} $INPUT
