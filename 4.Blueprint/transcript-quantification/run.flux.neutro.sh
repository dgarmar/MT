...
# Submission script. Run Flux-Capacitor on neutrophils' BAM files 
...
flux-capacitor -i $INPUT -a $ANNO -m SINGLE_STRANDED --read-strand ASENSE -o ../flux/neutrophils/gtf/${OUTPUT[ $SGE_TASK_ID ]}.gtf
